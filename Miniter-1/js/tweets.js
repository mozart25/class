...
//list.className ='tweets'; // 함정?
list.innerHTML=data[0].user;
list.innerHTML=data[1].contents;
...
for (let i=0; i< data.length; i++) {
 ...
 // list = list + i
  ...
  phrase.className = "pbold"
  var phrase2 = document.createElement('p')
  phrase2.className = "p2style"

  phrase.innerHTML = data[i].user;
  phrase2.innerHTML = data[i].contents;

  list.appendChild(phrase)
  list.appendChild(phrase2)
